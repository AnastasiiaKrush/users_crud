...
@section('content')
   ...
   <form id="user-update-form" name="user" class="needs-validation" novalidate>
        ...
        <fieldset>
            <div class="row">
                <div class="col">
                    <input value="{{ $user->name }}" name="name" type="text" class="form-control" placeholder="Name" required >
                </div>
                <div class="col">
            ...
            <div class="row">
                <div class="col">
                    <input value="{{ $user->birthday }}" id="birthday" name="birthday" type="date" min="1900-01-01" class="form-control" required>
                </div>
                <div class="col">
                    <input value="{{ $user->phone_number }}" name="phone_number" type="tel" class="form-control" placeholder="Phone number">
                </div>
            </div>
